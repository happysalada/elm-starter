...
var _moarwick$elm_webpack_starter$Update$parseLocation = function (location) {
	var _p0 = A2(_evancz$url_parser$UrlParser$parseHash, _moarwick$elm_webpack_starter$Update$matchers, location);
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
...
if (typeof _moarwick$elm_webpack_starter$App$main !== 'undefined') {
    _moarwick$elm_webpack_starter$App$main(Elm['App'], 'App', {"types":{"unions":{"Models.Message":{"args":[],"tags":{"OnLocationChange":["Navigation.Location"],"GoToAboutPage":[],"GoToMainPage":[],"NoOp":[]}}},"aliases":{"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Models.Message"},"versions":{"elm":"0.18.0"}});
}
