		...
		switch (_p3.ctor) {
			...
			case 'ReceiveOcrResults':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{ocrStatus: _moarwick$elm_webpack_starter$Models$ResponseReceived, ocrResponse: _p3._0}),
					{ctor: '[]'});
...
var _moarwick$elm_webpack_starter$View$showResponse = function (model) {
	...
	switch (_p0.ctor) {
		case 'NotAsked':
			return {
				ctor: '::',
				_0: _mdgriffith$style_elements$Element$text('画像処理に問題が発生しました'),
				_1: {ctor: '[]'}
			};
		case 'Loading':
			return {
				ctor: '::',
				_0: _mdgriffith$style_elements$Element$text('ローディング'),
				_1: {ctor: '[]'}
			};
		case 'Success':
			var _p3 = _p0._0;
					...
					A3(
						...
						{ctor: '[]'},
						{
							...
							_0: A3(
								...
								_moarwick$elm_webpack_starter$View$Logo,
								{ctor: '[]'},
								_mdgriffith$style_elements$Element$text('簡単にOCR')),
							_1: {ctor: '[]'}
						})),
				_1: {
					ctor: '::',
						...
						A3(
							...
							},
							{
								...
								_0: A3(
									...
									_moarwick$elm_webpack_starter$View$Title,
									{ctor: '[]'},
									_mdgriffith$style_elements$Element$text('簡単に画像にOCRをする')),
								_1: {
									ctor: '::',
									_0: A3(
										_mdgriffith$style_elements$Element$el,
										_moarwick$elm_webpack_starter$View$Subtitle,
										{ctor: '[]'},
										_mdgriffith$style_elements$Element$text('以下に画像をアップロードしてまたはドラッグ&ドロップしてから自動的にOCRしてくれます')),
									_1: {ctor: '[]'}
								}
							})),
					_1: {
								...
								function () {
									...
									switch (_p4.ctor) {
										case 'NoFileUploaded':
											return {
												ctor: '::',
												_0: _mdgriffith$style_elements$Element$text('画像をアップロードしてまたはドラッグ&ドロップ'),
												_1: {
													ctor: '::',
										...
										case 'UploadFileAction':
											return {
												ctor: '::',
												_0: _mdgriffith$style_elements$Element$text('ここにドロップ'),
												_1: {ctor: '[]'}
											};
										case 'FileUploaded':
											return {
										...
										case 'ParsingFile':
											return {
												ctor: '::',
												_0: _mdgriffith$style_elements$Element$text('画像処理中'),
												_1: {ctor: '[]'}
											};
										case 'SendingFile':
											return {
												ctor: '::',
												_0: _mdgriffith$style_elements$Element$text('処理されたデータにOCRを行い中'),
												_1: {ctor: '[]'}
											};
										default:
