...
var _moarwick$elm_webpack_starter$Models$ResponseReceived = {ctor: 'ResponseReceived'};
var _moarwick$elm_webpack_starter$Models$SendingFile = {ctor: 'SendingFile'};
var _moarwick$elm_webpack_starter$Models$ParsingFile = {ctor: 'ParsingFile'};
var _moarwick$elm_webpack_starter$Models$FileUploaded = {ctor: 'FileUploaded'};
var _moarwick$elm_webpack_starter$Models$UploadFileAction = {ctor: 'UploadFileAction'};
var _moarwick$elm_webpack_starter$Models$NoFileUploaded = {ctor: 'NoFileUploaded'};
var _moarwick$elm_webpack_starter$Models$initialModel = function (route) {
	return {
		route: route,
		device: _moarwick$elm_webpack_starter$Models$initialDevice,
		ocrStatus: _moarwick$elm_webpack_starter$Models$NoFileUploaded,
		dragAndDrop: 0,
		nativeFiles: {ctor: '[]'},
		imageData: '',
		ocrError: _elm_lang$core$Maybe$Nothing,
		ocrResponse: _krisajenkins$remotedata$RemoteData$NotAsked
	};
};
var _moarwick$elm_webpack_starter$Models$NoOp = {ctor: 'NoOp'};
var _moarwick$elm_webpack_starter$Models$ReceiveOcrResults = function (a) {
	return {ctor: 'ReceiveOcrResults', _0: a};
};
var _moarwick$elm_webpack_starter$Models$FileData = function (a) {
	return {ctor: 'FileData', _0: a};
};
var _moarwick$elm_webpack_starter$Models$ParseImageFile = {ctor: 'ParseImageFile'};
var _moarwick$elm_webpack_starter$Models$Drop = function (a) {
	return {ctor: 'Drop', _0: a};
};
var _moarwick$elm_webpack_starter$Models$DragLeave = {ctor: 'DragLeave'};
var _moarwick$elm_webpack_starter$Models$DragEnter = {ctor: 'DragEnter'};
...
var _moarwick$elm_webpack_starter$Update$ocrRequestBody = function (imagebase64String) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
...
var _moarwick$elm_webpack_starter$Update$ocrTextAnnotationDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'textAnnotations',
	_elm_lang$core$Json_Decode$list(_moarwick$elm_webpack_starter$Update$ocrDescriptionDecoder),
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_elm_lang$core$Basics$identity));
var _moarwick$elm_webpack_starter$Update$ocrResponseDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'response',
	_elm_lang$core$Json_Decode$list(_moarwick$elm_webpack_starter$Update$ocrTextAnnotationDecoder),
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_elm_lang$core$Basics$identity));
var _moarwick$elm_webpack_starter$Update$sendFiletoCloudVision = function (imagebase64String) {
	var request = _elm_lang$http$Http$request(
		{
			...
			body: A2(
				...
				'application/json',
				_moarwick$elm_webpack_starter$Update$ocrRequestBody(imagebase64String)),
			expect: _elm_lang$http$Http$expectJson(_moarwick$elm_webpack_starter$Update$ocrResponseDecoder),
			timeout: _elm_lang$core$Maybe$Nothing,
			withCredentials: false
		});
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_moarwick$elm_webpack_starter$Models$ReceiveOcrResults,
		_krisajenkins$remotedata$RemoteData$sendRequest(request));
};
var _moarwick$elm_webpack_starter$Update$parseFileToBase64 = function (nativeFiles) {
	var _p0 = nativeFiles;
	if (_p0.ctor === '::') {
		return A2(
			_elm_lang$core$Task$perform,
			_moarwick$elm_webpack_starter$Models$FileData,
			A2(
				_elm_lang$core$Task$onError,
				function (_p1) {
					return _elm_lang$core$Task$succeed(
				...
				A2(
					...
					_simonh1000$file_reader$FileReader$readAsDataUrl(
						function (_) {
							return _.blob;
						}(_p0._0)))));
	} else {
...
var _moarwick$elm_webpack_starter$Update$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
...
var _moarwick$elm_webpack_starter$Update$parseLocation = function (location) {
	var _p2 = A2(_evancz$url_parser$UrlParser$parseHash, _moarwick$elm_webpack_starter$Update$matchers, location);
	if (_p2.ctor === 'Just') {
		return _p2._0;
	} else {
		...
		switch (_p3.ctor) {
			case 'Resize':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							device: _mdgriffith$style_elements$Element$classifyDevice(_p3._0)
						}),
					{ctor: '[]'});
			case 'DragEnter':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{dragAndDrop: model.dragAndDrop + 1, ocrStatus: _moarwick$elm_webpack_starter$Models$UploadFileAction}),
					{ctor: '[]'});
			case 'DragLeave':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{dragAndDrop: model.dragAndDrop - 1}),
					{ctor: '[]'});
			case 'Drop':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{dragAndDrop: 0, nativeFiles: _p3._0, ocrStatus: _moarwick$elm_webpack_starter$Models$FileUploaded}),
					{ctor: '[]'});
			case 'FileData':
				if (_p3._0.ctor === 'Ok') {
					var imageBase64String = _elm_lang$core$Basics$toString(_p3._0._0);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{ocrStatus: _moarwick$elm_webpack_starter$Models$SendingFile, imageData: imageBase64String}),
						{
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Update$sendFiletoCloudVision(imageBase64String),
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								ocrError: _elm_lang$core$Maybe$Just(
			...
			case 'ParseImageFile':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{ocrStatus: _moarwick$elm_webpack_starter$Models$ParsingFile}),
					{
						ctor: '::',
						_0: _moarwick$elm_webpack_starter$Update$parseFileToBase64(model.nativeFiles),
						_1: {ctor: '[]'}
					});
			case 'ReceiveOcrResults':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{ocrStatus: _moarwick$elm_webpack_starter$Models$ResponseReceived}),
					{ctor: '[]'});
			case 'OnLocationChange':
				var newRoute = _moarwick$elm_webpack_starter$Update$parseLocation(_p3._0);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
...
var _moarwick$elm_webpack_starter$View$showResponse = function (model) {
	var _p0 = model.ocrResponse;
	switch (_p0.ctor) {
		case 'NotAsked':
			return {
				ctor: '::',
				_0: _mdgriffith$style_elements$Element$text('problem performing the request'),
				_1: {ctor: '[]'}
			};
		case 'Loading':
			return {
				ctor: '::',
				_0: _mdgriffith$style_elements$Element$text('loading...'),
				_1: {ctor: '[]'}
			};
		case 'Success':
			var _p2 = _p0._0;
			...
			if ((_p1.ctor === '::') && (_p1._0.ctor === '::')) {
				return {
					...
					_0: _mdgriffith$style_elements$Element$text(
						A2(_elm_lang$core$Basics_ops['++'], 'received', _p1._0._0)),
					_1: {ctor: '[]'}
				};
			} else {
				return {
...
var _moarwick$elm_webpack_starter$View$dragAndDropEventHandlers = {
	ctor: '::',
	_0: A3(
		_mdgriffith$style_elements$Element_Events$onWithOptions,
		'dragenter',
		{stopPropagation: false, preventDefault: true},
		_elm_lang$core$Json_Decode$succeed(_moarwick$elm_webpack_starter$Models$DragEnter)),
	_1: {
		ctor: '::',
		_0: A3(
			_mdgriffith$style_elements$Element_Events$onWithOptions,
			'dragover',
			{stopPropagation: false, preventDefault: true},
			_elm_lang$core$Json_Decode$succeed(_moarwick$elm_webpack_starter$Models$NoOp)),
		_1: {
			ctor: '::',
			_0: A3(
				_mdgriffith$style_elements$Element_Events$onWithOptions,
				'dragleave',
				{stopPropagation: false, preventDefault: true},
				_elm_lang$core$Json_Decode$succeed(_moarwick$elm_webpack_starter$Models$DragLeave)),
			_1: {
				ctor: '::',
				_0: A3(
					_mdgriffith$style_elements$Element_Events$onWithOptions,
					...
					A2(_elm_lang$core$Json_Decode$map, _moarwick$elm_webpack_starter$Models$Drop, _simonh1000$file_reader$FileReader$parseDroppedFiles)),
				_1: {ctor: '[]'}
			}
		}
	}
				...
				_0: A2(
					...
					_moarwick$elm_webpack_starter$View$Nav,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _mdgriffith$style_elements$Style_Color$background(_moarwick$elm_webpack_starter$View$mainColors.darkIndigo),
								_1: {ctor: '[]'}
							}
						}
					}),
					...
					_1: {
						...
						_0: A2(
							...
							_moarwick$elm_webpack_starter$View$Hero,
							{
								...
								_1: {
									ctor: '::',
									_0: _mdgriffith$style_elements$Style_Color$background(_moarwick$elm_webpack_starter$View$mainColors.indigo),
									_1: {
										ctor: '::',
										_0: _mdgriffith$style_elements$Style_Color$text(_elm_lang$core$Color$white),
										_1: {
								...
								function () {
									...
									switch (_p3.ctor) {
										case 'NoFileUploaded':
											return {
												ctor: '::',
												_0: _mdgriffith$style_elements$Element$text('upload a file with the button or drag and drop it'),
												_1: {
													ctor: '::',
																...
																_1: {
																	...
																	_1: {
																		...
																		_0: A2(
																			_elm_lang$html$Html_Events$on,
																			'change',
																			A2(_elm_lang$core$Json_Decode$map, _moarwick$elm_webpack_starter$Models$Drop, _simonh1000$file_reader$FileReader$parseSelectedFiles)),
																		_1: {ctor: '[]'}
																	}
																}
															},
										...
										case 'UploadFileAction':
											return {
												ctor: '::',
												_0: _mdgriffith$style_elements$Element$text('drop it here'),
												_1: {ctor: '[]'}
											};
										case 'FileUploaded':
											return {
												...
												_0: A3(
													...
													{
														ctor: '::',
														_0: _mdgriffith$style_elements$Element_Events$onClick(_moarwick$elm_webpack_starter$Models$ParseImageFile),
														_1: {ctor: '[]'}
													},
										...
										case 'ParsingFile':
											return {
												ctor: '::',
												_0: _mdgriffith$style_elements$Element$text('parsing file'),
												_1: {ctor: '[]'}
											};
										case 'SendingFile':
											return {
												ctor: '::',
												_0: _mdgriffith$style_elements$Element$text('sending file'),
												_1: {ctor: '[]'}
											};
										default:
											return _moarwick$elm_webpack_starter$View$showResponse(model);
									}
								}())),
						_1: {ctor: '[]'}
					}
...
var _moarwick$elm_webpack_starter$App$main = A2(
	...
	_moarwick$elm_webpack_starter$Models$OnLocationChange,
...
if (typeof _moarwick$elm_webpack_starter$App$main !== 'undefined') {
    _moarwick$elm_webpack_starter$App$main(Elm['App'], 'App', {"types":{"unions":{"MimeType.MimeVideo":{"args":[],"tags":{"OtherVideo":[],"Avi":[],"Mpeg":[],"Webm":[],"Quicktime":[],"Mp4":[]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"MimeType.MimeApp":{"args":[],"tags":{"WordXml":[],"PowerPointXml":[],"OtherApp":[],"Excel":[],"Pdf":[],"PowerPoint":[],"Word":[],"ExcelXml":[]}},"FileReader.Error":{"args":[],"tags":{"ReadFail":[],"NoValidBlob":[],"NotTextFile":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"MimeType.MimeAudio":{"args":[],"tags":{"Ogg":[],"OtherAudio":[],"Mp3":[],"Wav":[]}},"MimeType.MimeText":{"args":[],"tags":{"Json":[],"Css":[],"Xml":[],"OtherText":[],"PlainText":[],"Html":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Success":["a"],"Loading":[],"Failure":["e"]}},"MimeType.MimeType":{"args":[],"tags":{"Image":["MimeType.MimeImage"],"Text":["MimeType.MimeText"],"App":["MimeType.MimeApp"],"Video":["MimeType.MimeVideo"],"OtherMimeType":[],"Audio":["MimeType.MimeAudio"]}},"MimeType.MimeImage":{"args":[],"tags":{"Jpeg":[],"Gif":[],"OtherImage":[],"Png":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Models.Message":{"args":[],"tags":{"ParseImageFile":[],"ReceiveOcrResults":["RemoteData.WebData (List (List String))"],"OnLocationChange":["Navigation.Location"],"Resize":["Window.Size"],"GoToAboutPage":[],"DragLeave":[],"GoToMainPage":[],"Drop":["List FileReader.NativeFile"],"DragEnter":[],"FileData":["Result.Result FileReader.Error FileReader.FileContentDataUrl"],"NoOp":[]}}},"aliases":{"RemoteData.WebData":{"args":["a"],"type":"RemoteData.RemoteData Http.Error a"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"FileReader.FileContentDataUrl":{"args":[],"type":"Json.Decode.Value"},"Window.Size":{"args":[],"type":"{ width : Int, height : Int }"},"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"},"FileReader.NativeFile":{"args":[],"type":"{ name : String , size : Int , mimeType : Maybe.Maybe MimeType.MimeType , blob : FileReader.FileRef }"},"FileReader.FileRef":{"args":[],"type":"Json.Decode.Value"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Models.Message"},"versions":{"elm":"0.18.0"}});
}
